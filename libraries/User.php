...
class User
{
    ...
    {
        $this->db->query("INSERT INTO `users`(firstName, lastName, username, password, email, phone) VALUE(:fname, :lname, :username, :password, :email, :image, :user_desc)");
    ...
    {
        $this->db->query("SELECT * FROM `user` WHERE email = :user_email AND password = :user_password");
